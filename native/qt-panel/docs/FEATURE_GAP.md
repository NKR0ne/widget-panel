...
| TradingView heatmap drilldown | Partial | Native opens chart and heatmap paths and captures/syncs cookies through the now-validated CDP cookie protocol. | Runtime validation must confirm real TradingView sign-in, cookie capture, watchlist refresh, and heatmap drilldown. |
