...
| Diagnostics | Implemented | Native diagnostics expose island URL/title/status/error and service probes. `native/brave-host/test-protocol.ps1` performs a bounded real-browser check of state, correlated evaluation results, cookies, navigation, Back, and cleanup; the success path passed on 2026-07-12. | Extend site-specific diagnostics only when runtime failures show missing evidence. |
