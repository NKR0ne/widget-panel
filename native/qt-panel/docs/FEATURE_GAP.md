...
| FM radio | Implemented | Radio Browser discovery/search, cached station selection, persistent volume, stream metadata, and native Qt Multimedia playback. The cached list remains usable during directory outages. | Needs live station playback validation after deployment. |
