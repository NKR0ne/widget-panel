...
QtObject {
    readonly property color bgTint: Qt.rgba(0.043, 0.055, 0.09, 0.45)
    readonly property color cardFill: Qt.rgba(1, 1, 1, 0.05)
    readonly property color cardStroke: Qt.rgba(1, 1, 1, 0.08)
